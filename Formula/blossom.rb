class Blossom < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "3be0a6e75b18d9f92e9c2e73a3d762b9cadf06cfbc302492d6b2e06bd756de1c"
    end
    on_intel do
      url "https://github.com/wu-json/blossom/releases/download/v#{version}/blossom_#{version}_darwin_amd64.tar.gz"
      sha256 "b697510e70b9516ce5415479718c37c009aa20ca7fc5fefceac0e0b0c053b134"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "779ac12999341b61f431c57c5aa1e677e509923abc837aa89212654893fa42fd"
    end
    on_intel do
      url "https://github.com/wu-json/blossom/releases/download/v#{version}/blossom_#{version}_linux_amd64.tar.gz"
      sha256 "edd98b133844a620eecb05e37147d5d4c00acb8aacf9e5664c3de5d785aa5aa6"
    end
  end
